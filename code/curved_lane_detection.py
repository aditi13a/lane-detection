...
video = cv2.VideoCapture(r"E:\ADITI\ENGINEERING\RVU\SEM8\MAJOR PROJECT\PROJECT 3\lane-detection\data\curved_lane.mp4")

if not video.isOpened():
    print("ERROR: Video not opening")
    exit()

out = cv2.VideoWriter(r"E:\ADITI\ENGINEERING\RVU\SEM8\MAJOR PROJECT\PROJECT 3\lane-detection\results\curve_lane_detection.avi",cv2.VideoWriter_fourcc(*'XVID'), 25, (1280,720))
